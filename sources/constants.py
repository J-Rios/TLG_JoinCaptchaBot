...
CONST = {
    ...
    'VERSION' : '1.2.8 (16/04/2019)' # Bot version
}
...
TEXT = {
    ...
    'ES' : {
        ...
        'NEW_USER_CAPTCHA_CAPTION' : \
            ...
            '{} mins, serás expulsado del grupo automáticamente.',
        ...
        'NEW_USER_KICK' : \
            '{} no completó el captcha a tiempo. El "usuario" fue expulsado.',

       'NEW_USER_KICK_NOT_RIGHTS' : \
            '{} no completó el captcha a tiempo. El "usuario" debería ser expulsado, pero ' \
        ...
        'NEW_USER_KICK_NOT_IN_CHAT' : \
            ...
            'se encuentra en el grupo (salió del grupo o fue expulsado/rechazado por un Admin).',
        ...
        'NEW_USER_BAN' : \
            ...
            'y no pudo resolver el captcha. El "usuario" fue rechazado. Para permitir que intente ' \
        ...
        'NEW_USER_BAN_NOT_IN_CHAT' : \
            'Atención: Esta es la tercera vez que el usuario {} ha intentado unirse al grupo ' \
            'y no pudo resolver el captcha. El "usuario" debería ser rechazado, pero ya no se ' \
            'encuentra en el grupo (salió del grupo o fue expulsado/rechazado por un Admin).',

        'NEW_USER_BAN_NOT_RIGHTS' : \
            'Atención: Esta es la tercera vez que el usuario {} ha intentado unirse al grupo ' \
            'y no pudo resolver el captcha. El "usuario" debería ser rechazado, pero no se me han ' \
            'dado los privilegios de administración necesarios para expulsar usuarios del grupo.',

        'BOT_CANT_BAN' : \
            'Atención: Esta es la tercera vez que el usuario {} ha intentado unirse al grupo ' \
            'y no pudo resolver el captcha. El "usuario" debería ser rechazado, pero debido a un ' \
